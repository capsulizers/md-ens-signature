...
const ICON_SOURCES = import.meta.glob<string>(
  "../node_modules/bootstrap-icons/icons/{box-arrow-up-right,check-circle-fill,circle,download,file-earmark,folder2-open,person-check,person-plus,person-x,pen,hourglass-split,patch-check-fill,question-diamond,search,send,shield-exclamation,stars,wallet2,x-octagon-fill}.svg",
  {
    eager: true,
    import: "default",
    query: "?raw",
